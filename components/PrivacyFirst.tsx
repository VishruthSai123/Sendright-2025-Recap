      ...
      <div className="max-w-lg sm:max-w-2xl z-10 flex flex-col items-center justify-center gap-4 sm:gap-6 px-2">
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-green-400 to-emerald-600 rounded-full flex items-center justify-center shadow-lg shadow-green-500/30">
            <HiLockClosed size={24} color="white" />
          </div>
        </motion.div>
        ...
        <div className="space-y-1 sm:space-y-2">
          ...
          <motion.h2
            ...
            className="text-2xl sm:text-4xl md:text-6xl font-black tracking-tight bg-gradient-to-r from-green-400 to-emerald-500 bg-clip-text text-transparent"
          >
            Your Device.
          </motion.h2>
        </div>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-2 sm:gap-3 pt-2 w-full">
          {[
            ...
            <motion.div
              ...
              className="flex items-center justify-center gap-2 px-3 py-2 sm:px-4 sm:py-3 bg-white/5 border border-white/10 rounded-xl backdrop-blur-sm"
            >
              <item.Icon size={16} color="#22c55e" />
              <span className="text-xs sm:text-sm font-medium text-white/70">{item.text}</span>
            </motion.div>
          ))}
        </div>
        ...
        <motion.p
          ...
          className="text-[10px] sm:text-xs md:text-sm text-white/30 pt-1"
        >
