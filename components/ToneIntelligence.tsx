    ...
    <section className="h-screen w-full flex flex-col items-center justify-center text-center px-4 sm:px-6 relative overflow-hidden bg-[#050505]">
      ...
      <div className="max-w-lg w-full z-10 space-y-5 sm:space-y-6">
        ...
        <motion.div
          ...
          className="space-y-1"
        >
          <h2 className="text-2xl sm:text-4xl md:text-5xl font-black tracking-tight">One Message.</h2>
          <h2 className="text-2xl sm:text-4xl md:text-5xl font-black tracking-tight bg-gradient-to-r from-green-400 to-emerald-500 bg-clip-text text-transparent">Any Tone.</h2>
        </motion.div>
